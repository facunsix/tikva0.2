          ...
          <CardContent className="p-8 text-center relative z-10">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg mb-6 text-primary-foreground/90">
                Aprovecha nuestros precios únicos y recibe tu pedido sin costo adicional
              </p>
              <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="text-center p-6 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950">
            <CardContent className="p-0">
              ...
              <h3 className="font-semibold mb-2 text-green-800 dark:text-green-200">Envío Gratis</h3>
              <p className="text-sm text-green-700 dark:text-green-300">
                En todas las compras sin mínimo
              </p>
            </CardContent>
          </Card>
